...
* **Psychology**: Leverages the *Seinfeld Strategy* ("Don't break the chain").
* **Technical Spec**:
...
* **Actionability**: If the wave is too high, the UI should suggest: *"Pause new cards for a few days."*
...
* **Plain English Insights**: Don't just show a graph. Add textual analysis: *"You are crushing it! Your retention is 92%, which is top 10% of users."*
