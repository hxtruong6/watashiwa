...
| **Engineer**      | **Critique**: "I won't build specific mockups that I have to throw away."<br>**Consensus**: "We build the REAL architecture (Zustand + Types + Server Actions), but we feed it _static seed data_ to save time on the AI pipeline."              |
